...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Jessica', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Keep the blade ever sharp', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-two-livid-92.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, Jessica', // 网站关键词 英文逗号隔开
